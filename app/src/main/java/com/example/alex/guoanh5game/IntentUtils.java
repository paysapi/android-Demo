...
import com.example.alex.guoanh5game.IWebView;
...
public class IntentUtils {
     ...
     */
    public static boolean handleExternalUri(final Context context, final WebView webView, final String uri) {
...
//            final CharSequence externalAppTitle = info.loadLabel(packageManager);
            try{
                ...
                Log.e("exception","not found intent:"+intent);
            }
            return true;
    ...
    private static boolean handleUnsupportedLink(final Context context, final WebView webView, final Intent intent) {
        ...
        if (intent.getPackage() != null) {
            ...
            try{
                info = packageManager.resolveActivity(marketIntent, 0);
